...
import { FileTextIcon, CaretDownIcon } from "@phosphor-icons/react";

export function AboutMe() {
  const [isOpenModal, setIsOpenModal] = useState(false);
  const [modalType, setModalType] =
    useState<"resume" | "pitch" | "letter">("resume");
  ...
  return (
    <section
      id="about"
      className="w-full py-16 md:py-24 bg-gradient-to-b from-[#1a1c23] to-[#121217]"
    ...
    >
      ...
      <motion.div
        ...
        className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center"
      >
        <motion.div
        ...
        >
          {[1, 2].map((index) => (
            <motion.div
              ...
              className="relative w-full aspect-[3/4] sm:h-96 rounded-2xl overflow-hidden group"
            >
              <Image
              ...
              <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 shadow-[inset_0_0_40px_rgba(168,85,247,0.35)] transition-all duration-500" />
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <div className="text-center lg:text-left">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="h-1 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full mt-3 mb-6 shadow-lg mx-auto lg:mx-0"
            />
          </div>
